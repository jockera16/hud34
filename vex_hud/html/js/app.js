...
(() => {
    ...
    QBHud.CarHud = function(data) {
        if (data.show) {
            ...
            $('.food-circle').animate({"top": "10.5vh"});
            $('.thirst-circle').animate({"top": "14.5vh"});
            $('.stress-circle').animate({"top": "18.5vh"});

            $('.hp-circle').animate({"left": "0vh"});
            $('.armor-circle').animate({"left": "0vh"});
            $('.food-circle').animate({"left": "0vh"});
            $('.thirst-circle').animate({"left": "0vh"});
            $('.stress-circle').animate({"left": "0vh"});

            $('.hp-circle').animate({"top": "2.5vh"});
            $('.armor-circle').animate({"top": "6.5vh"});
        }
    };
