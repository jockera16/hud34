...
--[[
RegisterNetEvent("Framework:player:onLogout")
AddEventHandler("Framework:player:onLogout", function()
    isLoggedIn = false
    Config.Show = false
    SendNUIMessage({
        action = "hudtick",
...
RegisterNetEvent("Framework:player:onLogin")
AddEventHandler("Framework:player:onLogin", function()
    isLoggedIn = true
    Config.Show = true
end)]]--
